...
def checkOpenContacts (contactList, notifyOptions, keypad)
	...
	def evt
	logdebug "checkOpenContacts $contactList $notifyOptions $keypad lastDoorsDtim: $lastDoorsDtim Duration: $duration"
	contactList.each
		{
...
def HeDoorsResetDelay(evt)
	{
	logdebug "entering HeDoorsResetDelay ${location.hsmStatus}"
